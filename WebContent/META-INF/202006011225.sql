CREATE DATABASE  IF NOT EXISTS `swimbusan` /*!40100 DEFAULT CHARACTER SET utf8 */;
USE `swimbusan`;
...
INSERT INTO `gallery` VALUES (1,'2','이순신','2','농특산품 & 우수중소기업박람회','농특산품 & 우수중소기업박람회','img_11.jpg,img_12.jpg,img_13.jpg',1,0,0,15,'2020-05-31 23:18:05','0:0:0:0:0:0:0:1',NULL),(3,'2','이순신','2','농특산품 & 우수중소기업박람회','농특산품 & 우수중소기업박람회','img_21.jpg,,',3,0,0,4,'2020-05-31 23:26:52','0:0:0:0:0:0:0:1',NULL),(4,'2','이순신','2','부산 MBC','부산 MBC','img_31.png',4,0,0,2,'2020-05-31 23:27:37','0:0:0:0:0:0:0:1',NULL),(5,'2','이순신','2','농특산품 & 우수중소기업박람회','농특산품 & 우수중소기업박람회','img_12.jpg',5,0,0,0,'2020-05-31 23:40:10','0:0:0:0:0:0:0:1',NULL),(6,'2','이순신','2','농특산품 & 우수중소기업박람회','농특산품 & 우수중소기업박람회','img_13.jpg',6,0,0,0,'2020-05-31 23:40:18','0:0:0:0:0:0:0:1',NULL),(8,'2','이순신','2','배경이미지','배경이미지','11.jpg,12.jpg,13.jpg',8,0,0,0,'2020-05-31 23:46:43','0:0:0:0:0:0:0:1',NULL),(9,'2','이순신','2','모뉴먼트밸리','모뉴먼트밸리','mv_oct13_05_0.png,mv_oct13_06_0.png,screenshot1.jpg',9,0,0,2,'2020-05-31 23:54:38','0:0:0:0:0:0:0:1',NULL),(10,'2','이순신','2','해변','해변','e8.jpg,c3.jpg,e2.jpg',10,0,0,1,'2020-05-31 23:57:19','0:0:0:0:0:0:0:1',NULL);
...
INSERT INTO `info` VALUES (1,'1','홍길동','1','수영 영법의 종류','수영 영법은 4가지가 있습니다.\r\n\r\n1. 자유형\r\n2. 배영\r\n3. 평영\r\n4. 접영',NULL,1,0,0,1,'2020-05-31 11:10:45','0:0:0:0:0:0:0:1',NULL),(2,'1','홍길동','1','자유형이란?','자유형은 형식에 제한이 없음을 뜻한다.\r\n\r\n그래서 자유형 경기 때는 배영, 평영, 접영을 해도 상관없다.',NULL,2,0,0,1,'2020-05-31 11:12:11','0:0:0:0:0:0:0:1',NULL),(3,'1','홍길동','1','배영이란?','배영은 누운 채 물 위에 떠서 팔을 크게 휘저으며 나아가는 영법이다.',NULL,3,0,0,1,'2020-05-31 11:13:29','0:0:0:0:0:0:0:1',NULL),(4,'1','홍길동','1','평영이란?','평영은 팔과 다리의 동작이 마치 개구리와 비슷해서 개구리 헤엄이라 부르기도 한다.\r\n\r\n팔을 앞으로 모았다가 양 옆으로 펼쳐 밀어내며 추진력을 얻는다.\r\n\r\n다리는 무릎과 발목을 직각으로 해서 뒤로 모았다가 발목과 무릎을 밖으로 벌리면서 다리를 쭉 펴주면 된다.',NULL,4,0,0,6,'2020-05-31 11:32:04','0:0:0:0:0:0:0:1',NULL),(5,'1','홍길동','1','답글 : 수영 영법의 종류','4가지 기본 영법 이외에는 다음과 같은 영법이 있습니다.\r\n\r\n1. 잠영\r\n2. 입영\r\n3. 횡영',NULL,1,1,1,1,'2020-05-31 12:14:26','0:0:0:0:0:0:0:1',NULL),(6,'1','홍길동','1','접영이란?','접영은 나비 영법이라고 불리우며 4개의 기본 영법 중에서 가장 에너지 소모가 많은 영법이다.',NULL,6,0,0,1,'2020-05-31 12:18:54','0:0:0:0:0:0:0:1',NULL);
...
INSERT INTO `member` VALUES ('1','1','홍길동','1@1',6561,'서울 서초구 동광로19길 10','1','1','2020-05-30'),('2','2','이순신','2@2',0,NULL,NULL,NULL,'2020-05-30'),('admin','1234','관리자','admin@admin',0,NULL,NULL,NULL,'2020-05-31');
...
INSERT INTO `review` VALUES (1,'1','홍길동','1','연제국민체육센터 수영장 후기입니다.','후기',NULL,1,0,0,21,'2020-05-31 12:53:22','0:0:0:0:0:0:0:1','연제구국민체육센터'),(2,'1','홍길동','1','사직수영장 후기입니다.','후기',NULL,2,0,0,37,'2020-05-31 12:58:45','0:0:0:0:0:0:0:1','사직수영장'),(4,'2','이순신','2','답글 : 사직수영장 후기입니다.','후기답글','img_11.jpg',2,1,1,9,'2020-05-31 13:38:06','0:0:0:0:0:0:0:1','사직수영장'),(5,'1','홍길동','1','사직 후기 1','후기',NULL,5,0,0,3,'2020-05-31 17:18:09','0:0:0:0:0:0:0:1','사직수영장'),(6,'2','이순신','2','동래구국민체육센터 후기','후기',NULL,6,0,0,5,'2020-05-31 18:52:24','0:0:0:0:0:0:0:1','동래구국민체육센터');
...
-- Dump completed on 2020-06-01  0:25:57
